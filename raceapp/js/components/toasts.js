...
class ComponentsToasts {
    ...
    _initLiveToast() {
        ...
        if (liveToastEl ? true : false) {
            ...
            import('../helpers/htmlLoader.js')
                .then((module) => {
                    console.log('htmlLoader import at ComponentsToasts - OK');
                ...
                .catch((err) => {
                    console.log(`htmlLoader import at ComponentsToasts - ${err.message}`);
                });
    ...
    Toast(message, backgroundColor, confirm_mode, action ) {
        if (this._liveToast ? true : false) {
            ...
            if (live ? true : false) {
                ...
                // if (backgroundColor ? true : false) {
                //     liveToastElem.classList.add(backgroundColor);
                // }

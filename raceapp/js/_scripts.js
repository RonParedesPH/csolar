...
export default class Scripts {
  ...
  _initBase() {
    ...
    if (typeof Nav !== "undefined") {
      ...
      console.log('scripts-> components.nav loaded')
    }

    // Search implementation
    if (typeof Search !== "undefined") {
      const search = new Search();
      console.log('scripts-> components.search loaded')
    }

    // AcornIcons initialization
    if (typeof AcornIcons !== "undefined") {
      new AcornIcons().replace();
      console.log('scripts-> components.acornIcons loaded')
    }
  }
  ...
  _initCommon() {
    ...
    if (typeof Common !== "undefined") {
      ...
      console.log('scripts-> common.common loaded')
    }
  }
  ...
  _initIcons() {
    ...
    if (typeof Icons !== "undefined") {
      ...
      console.log('scripts-> apps.icons loaded')
    }
  }
  ...
  _initApps() {
    ...
    if (typeof Calendar !== "undefined") {
      ...
      console.log('scripts-> apps.Calendar loaded')
    }
    // mailbox.js initialization
    if (typeof Mailbox !== "undefined") {
      let mailbox = new Mailbox();
      console.log('scripts-> apps.Mailbox loaded')
    }
    // contacts.js initialization
    if (typeof Contacts !== "undefined") {
      let contacts = new Contacts();
      console.log('scripts-> apps.Contacts loaded')
    }
    // chat.js initialization
    if (typeof Chat !== "undefined") {
      const chat = new Chat();
      console.log('scripts-> apps.Chat loaded')
    }
    // task.js initialization
    if (typeof Tasks !== "undefined") {
      const tasks = new Tasks();
      console.log('scripts-> apps.Tasks loaded')
    }
  }
  ...
  _initPages() {
    ...
    if (typeof PagesLanding !== "undefined") {
      const pagesLanding = new PagesLanding();
    }
  }

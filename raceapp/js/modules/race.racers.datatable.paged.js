...
class RaceRacersDataTablePaged {
    constructor(race_racersApi) {
        _this = this
        this.Race_RacersApi = race_racersApi
    }
    ...
    _createInstance(e) {
        ...
        this._datatable = jQuery(e).DataTable({
            ...
            ajax: {
                ...
                url: race_RacersApi._path + '/racers',
                dataSrc: function(json)
                    {
                        let a = [];
                    json.forEach(d => {
                        a.push({Number: d.Number,
                            Name: d.Name,
                            CarDetails: d.CarDetails,
                            RaceClass: d.RaceClass,
                            TeamIdOptional: d.TeamIdOptional,
            ...
            columnDefs: [
                {
                    ...
                    render: function (data, type, row, meta) {
                        ...
                        return '<span class="badge bg-outline-info"><i class="fas fa-bell"></i> ' + dt.toLocaleDateString('en-US',{
                            ...
                            year: '2-digit', // "2024"document.getElementById("responsiveTabs")
...
export default RaceRacersDataTablePaged;

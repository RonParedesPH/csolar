...
class RaceRoundsDataTablePaged {
    constructor(race_roundsApi) {
        _this = this
        this.Race_RoundsApi = race_roundsApi
    ...
    _createInstance(e) {
        ...
        const race_RacersApi = new this.Race_RoundsApi()
        this._datatable = jQuery(e).DataTable({
            ...
            ajax: {
                ...
                url: race_RacersApi._path + '/rounds',
            ...
            columnDefs: [
                {
                    ...
                    render: function (data, type, row, meta) {
                        ...
                        return '<span class="badge bg-outline-info"><i class="fas fa-bell"></i> ' + 
                            (meta.col==1 ? datestring.substring(0, 13) : datestring) +
                             '</span>';
                    },
                },{
                    targets: [4],
                    render: function (data, type, row, meta) {
                        return '<span class="badge bg-primary text-uppercase hotlink" data-round-id="' + row.Id + 
                            '" data-round-name="' + row.Name + '"><i class="fas fa-bell"></i> Download </span>'
                    }
                }
    ...
    _addListeners() {
        ...
        // document.querySelectorAll('.hotlink').forEach((el) => el.addEventListener('click', (e) => 
        //     id = e.dataset.roundId;
        //     this._updateTag('Sale')
        // ));
    }
...
export default RaceRoundsDataTablePaged;
